                        ...
                        <div class="row">
                            <div class="col-lg-10 col-12 mx-auto">
                                <form method="post" autocomplete="off">
                                    ...
                                    <!--            <input type="text" value="" name="acct_no" class="form-control"  placeholder="Account Number" required>-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" value="" name="firstname" class="form-control" id="" placeholder="First Name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="">Last Name</label>
                                                <input type="text" value="" name="lastname" class="form-control" id="" placeholder="Last Name" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input value="" type="text" name="acct_balance" class="form-control" id="" placeholder="Account Balance" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" value="" name="ssn" class="form-control"  placeholder="Social Security Number" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input value="" name="acct_address" type="text" class="form-control" id="" placeholder="Address" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input value="" type="email" class="form-control" id="rEmail" placeholder="Account Email" name="acct_email" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="">Phone Number</label>
                                                <input value="" name="acct_phone" type="number" class="form-control" id="" placeholder="Phone Number" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input value="" name="acct_occupation" type="text" class="form-control" id="" placeholder="Occupation" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                <label for="">Date of Birth</label>
                                                <input value="" name="acct_dob" type="date" class="form-control" id="" placeholder="Date Of Birth" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input value="" name="state" type="text" class="form-control" id="" placeholder="State" required>
                                            </div>
                                        </div>
                                    </div>
